...
# Code from https://gist.github.com/duhaime/211365edaddf7ff89c0a36d9f3f7956c
...
def get_img(path, norm_size=True, norm_exposure=False):
    ...
    img = cv2.imread(path).flatten().astype(int)
...
if __name__ == '__main__':
    img_a = "images/mountain.jpg"
    img_b = "output/mountain/gen/20.jpg"
