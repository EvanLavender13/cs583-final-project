...
time python3 main.py images/small_tower.jpg 242 286 output/small_tower/05_10_05_default.jpg 5 10 0.05
time python3 main.py images/small_tower.jpg 242 286 output/small_tower/10_10_05_default.jpg 10 10 0.05
time python3 main.py images/small_tower.jpg 242 286 output/small_tower/25_10_05_default.jpg 25 10 0.05

mkdir -p output/waterfall
time python3 main.py images/waterfall.jpg 263 316 output/waterfall/05_10_05_default.jpg 5 10 0.05
time python3 main.py images/waterfall.jpg 263 316 output/waterfall/10_10_05_default.jpg 10 10 0.05
...
time python3 main.py images/whale.jpg 340 408 output/whale/10_10_05_default.jpg 10 10 0.05
time python3 main.py images/whale.jpg 340 408 output/whale/25_10_05_default.jpg 25 10 0.05
###########################################################################

# Constant pop size, varied number of gens, constant mut rate, default stuff
###########################################################################
mkdir -p output/small_tower
time python3 main.py images/small_tower.jpg 242 286 output/small_tower/10_2005_default.jpg 10 20 0.05
time python3 main.py images/small_tower.jpg 242 286 output/small_tower/10_3005_default.jpg 10 30 0.05

mkdir -p output/waterfall
time python3 main.py images/waterfall.jpg 263 316 output/waterfall/10_2005_default.jpg 10 20 0.05
...
time python3 main.py images/whale.jpg 340 408 output/whale/10_3005_default.jpg 10 30 0.05
###########################################################################
